...
using System.Linq;
using static OwlGame.TilemapClasses.RectDirections;


namespace OwlGame.Entities
{
    //Student Num: c3260058
    //Stundent Name: Kira Khristosova
    //Date: 04/10/18
    //Description: Determines Level Collision with the player class and doesnt allow the player to fall or go out of level borders in the .tmx file.
